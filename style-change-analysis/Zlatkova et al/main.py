...
from models import MLP, SVM, MLP_GMM, LogReg, MLP_max_diff, Stacking, StackingSimple, LSTM_model, CharacterCNN, BaselineRND
...
def main(test_data,
    ...
    predictions = test(clf, train_x, train_y, train_positions, with_full_data_tfidf, test_data)
    return predictions
